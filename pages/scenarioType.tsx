        ...
        <div className="row scenario">
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <input type="text" id="scenario" name="scenariotype" required value={scenariotype} onChange={handleInput} />
            </div>
            {scenariotypeErr != "" && (
 ...
 */}
          <button className="create-template" onClick={() => handleCreateScenario()} >SUBMIT</button>
