        ...
        <div className="row">
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <select name="scenarioType" id="type" value={scenarioType} onChange={handleInput}>
          ...
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <input type="text" id="alpha0" name="alpha0" required value={alpha0} onChange={handleInput} />
            </div>
            {alpha0Err != "" && (
          ...
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <input type="text" id="theta0" name="theta0" required value={theta0} onChange={handleInput} />
            </div>
            {theta0Err != "" && (
          ...
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <input type="text" id="name" name="templatename" required value={templatename} onChange={handleInput} />
            </div>
            {templatenameErr != "" && (
          ...
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <input type="text" id="alpha1" name="alpha1" required value={alpha1} onChange={handleInput} />
            </div>
            {alpha1Err != "" && (
          ...
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <input type="text" id="theta1" name="theta1" required value={theta1} onChange={handleInput} />
            </div>
            {theta1Err != "" && (
          ...
          <div className="col-md-6 mb-3">
            <div className="form-content">
              ...
              <input type="text" id="comment" name="comment" required value={comment} onChange={handleInput} />
            </div>
            {commentErr != "" && (
          ...
          <button className="create-template" onClick={() => handleCreateTemplate()} >CREATE TEMPLATE </button>
